...
namespace TutoMVC.Controllers
{
    public class AgentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Nom,Prenom,Email,CIN,sexe,DateNaissance,LieuNaissance,Nationalite,SecondeNationalite,Matricule,NbrEnfants")] Agent agent)
        {
            if (ModelState.IsValid)
            {
